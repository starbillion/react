...
class AudioTourList extends React.Component {
    ...
    render() {
        ...
        return (
            <div className="view white p-3">
                    <Row>
                            <div className="heading col-12 p-0">
                                <div className="text-center col-lg-12" style={{color: "#262626", fontSize: 14}}>
                                    TOURS
                                </div>
                            </div>
                            <div className="nav-container">
                                <Nav pills>
                                    ...
                                    <NavItem>
                                        <NavLink style={{cursor: 'not-allowed'}}>PURCHASED</NavLink>
                                    </NavItem>
                                </Nav>
                            </div>
                            <div className="flex-column audio-body">
                                ...
                                {tours.map(function(item, index) {
                                    return <div key={index}>
                                                <Card className="flex-row"  onClick={(e) => _this.toggle(e, 'modalFadeInScale edit-tour-modal', item.id)} >
