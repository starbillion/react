        ...
        <div className="ml-auto d-flex">
            {
                ...
                <div className="hidden-sm-down">
                    <LineChart width={100} height={35} data={tinyChartData}>
                        <Line type='monotone' dataKey='growth' stroke='#F99A0C' strokeWidth={1} dot={{strokeWidth: 0, r: 2}}/>
                        <Tooltip content={<IncomeGrowthTooltip/>}/>
                    </LineChart>
                    <p className="small text-uppercase text-white">Weekly Income</p>
                </div>
                <div className="d-flex flex-btn">
                    ...
                    <div className="ml-5">
                        <BarChart width={100} height={35} data={tinyChartData}>
                            <Bar type='monotone' dataKey='traffic' fill='#F99A0C'/>
                        </BarChart>
